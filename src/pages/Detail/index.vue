          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr,index) in spuSaleAttrList" :key="attr.id">
                ...
                <dd changepirce="0" v-for="(value,index) 
                in attr.spuSaleAttrValueList" :key="value.id" 
